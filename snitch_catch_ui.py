...
class Ui_SnitchCatch(object):
    def setupUi(self, SnitchCatch):
        ...
        self.groupBox = QtWidgets.QGroupBox(SnitchCatch)
        self.groupBox.setTitle("")
        self.groupBox.setObjectName("groupBox")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.groupBox)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.firstCatchButton = QtWidgets.QRadioButton(self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.firstCatchButton.setFont(font)
        self.firstCatchButton.setChecked(True)
        self.firstCatchButton.setAutoExclusive(True)
        self.firstCatchButton.setObjectName("firstCatchButton")
        self.horizontalLayout_4.addWidget(self.firstCatchButton)
        self.secondCatchButton = QtWidgets.QRadioButton(self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.secondCatchButton.setFont(font)
        self.secondCatchButton.setObjectName("secondCatchButton")
        self.horizontalLayout_4.addWidget(self.secondCatchButton)
    ...
    def retranslateUi(self, SnitchCatch):
        ...
        self.firstCatchButton.setText(_translate("SnitchCatch", "First Catch"))
        self.secondCatchButton.setText(_translate("SnitchCatch", "Second Catch"))
